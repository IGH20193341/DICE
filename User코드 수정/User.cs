...
public class User : MonoBehaviour
{
    ...
    public void Move()
    {
        ...
        //rigid.velocity = new Vector3(h, 0, v); // z축으로 이동
        //rigid.AddForce(new Vector3(h, 0, v), ForceMode.Impulse);
        transform.Translate(0, 0, moveSpeed);

        // rigid.velocity = new Vector3(dir.x * SideSpeed, 0, moveSpeed * Time.deltaTime*100);
        // rigid.AddForce(new Vector3(0, 0, moveSpeed * Time.deltaTime), ForceMode.Impulse);
